...
/// Virtual key code → a label you'd actually recognize. Used by the macro
/// step inspector and by the hotkey recorder, so a saved trigger reads as
/// "⌃⌥F1" instead of "modifiers + 122".
enum KeyCodes {
    ...
    /// True for keys that only make sense as part of a combination, so the
    /// hotkey recorder can ignore a bare Shift press while you're reaching
    /// for the real key.
    ...
    private static let table: [UInt16: String] = [
        ...
        54: "Right ⌘", 55: "⌘", 56: "⇧", 57: "Caps Lock", 58: "⌥",
        59: "⌃", 60: "Right ⇧", 61: "Right ⌥", 62: "Right ⌃", 63: "Fn",
        64: "F17", 65: "Keypad .", 67: "Keypad *", 69: "Keypad +",
        71: "Keypad Clear", 75: "Keypad /", 76: "Keypad Enter",
